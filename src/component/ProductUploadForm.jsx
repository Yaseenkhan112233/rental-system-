...
//     price: "",
//     description: "",
//     // Only colors and material in specifications
//     colors: [],
//     material: "",
//     tags: "",
//     imageLinks: [],
...
//   // Handle dimension changes - REMOVED
...
//   // Handle certification management - REMOVED
...
const ProductUploadForm = ({ onClose }) => {
  const [loading, setLoading] = useState(false);
  const [formData, setFormData] = useState({
    productName: "",
    category: "",
  ...
  const handleSubmit = async (e, isDraft = false) => {
    ...
    try {
      ...
      if (onClose) {
        ...
        // Navigate back to home if no onClose prop (fallback)
        setTimeout(() => {
          navigate("/");
        }, 1000); // 1 second delay to show the alert
      }
